...
\begin{center}
\begin{tikzpicture}
\node [circle, draw=black, minimum size=0.2cm] (a){C};
	\node [circle,draw=black ,minimum size=0.2cm] (b)[below=1.5cm of a]{x};

	\draw [->,draw=black] (a) to (b);
	
	\node [circle,draw =black, minimum size = 0.2cm](c)[right=6cm of a]{C};
	\node [circle,draw =red, minimum size = 0.2cm](d)[below right=0.75cm of c]{z};
		\node [circle,draw =black, minimum size = 0.2cm](e)[below =1.5cm of c]{x};
		\draw [->,draw=red] (c) to (d);
		\draw [->,draw=black] (c) to (e);
		\draw [->,draw=red] (d) to (e);
\end{tikzpicture}
\end{center}
